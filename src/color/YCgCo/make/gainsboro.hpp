#ifndef color_YCgCo_make_gainsboro
#define color_YCgCo_make_gainsboro
   ...
   namespace make
    { //RGB equivalents: std::array<double,3>( { 0.858824, 0.858824, 0.858824 } ) - rgb(219,219,219) - #DBDBDB
     ...
     template< typename tag_name >
      inline
      void gainsboro( ::color::model< ::color::category::YCgCo< tag_name > > & color_parameter )
       {
        ...
        static left_type local( right_type( { 0.858823529, -0.5, -0.5 } ) );
