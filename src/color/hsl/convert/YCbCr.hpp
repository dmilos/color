#ifndef color_hsl_convert_YCbCr
#define color_hsl_convert_YCbCr
  ...
  namespace _internal
   {
    ...
    template< typename hsl_tag_name, typename YCbCr_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = hsl_model_type( rgb_model_type( YCbCr_model_type( right ) ) ).container();
          }
        };
