#ifndef color_cmyk_convert_hcg
#define color_cmyk_convert_hcg
  ...
  namespace _internal
   {
    ...
    template< typename cmyk_tag_name, typename hcg_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = cmyk_model_type( rgb_model_type( hcg_model_type( right ) ) ).container();
          }
        };
