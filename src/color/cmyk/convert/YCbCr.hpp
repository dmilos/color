#ifndef color_cmyk_convert_YCbCr
#define color_cmyk_convert_YCbCr
  ...
  namespace _internal
   {
    ...
    template< typename cmyk_tag_name, typename YCbCr_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = cmyk_model_type( rgb_model_type( YCbCr_model_type( right ) ) ).container();
          }
        };
