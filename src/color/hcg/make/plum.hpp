...
// ::color::make::plum( c )
 ...
 namespace color
  {
   namespace make
    { //RGB equivalents: std::array<double,3>( { 0.866667, 0.627451, 0.866667 } ) - rgb(221,159,221) - #DD9FDD
      ...
      void plum( ::color::model< ::color::category::hcg< tag_name > > & color_parameter )
       {
        ...
        static left_type local( right_type( { 300, 23.921568627451, 82.4742268041237 } ) );
