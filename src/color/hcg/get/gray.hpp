#ifndef color_hcg_get_gray
#define color_hcg_get_gray

// ::color::get::gray( c )

#include "../../gray/place/place.hpp"
#include "../../gray/akin/hcg.hpp"
   ...
   namespace get
    {
     ...
     template< typename tag_name >
      inline
      typename ::color::trait::component< typename ::color::akin::gray< ::color::category::hcg<tag_name> >::akin_type >::return_type
      gray( ::color::model< ::color::category::hcg<tag_name> > const& color_parameter )
       {
