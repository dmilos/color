#ifndef color_hcg_check_integrity
#define color_hcg_check_integrity
    ...
    namespace _internal
     {
      ...
      template<>
       struct integrity< ::color::category::hcg_float>
        {
         public:
          typedef ::color::category::hcg_float category_type;
      ...
      template<>
       struct integrity< ::color::category::hcg_double >
        {
         public:
          typedef ::color::category::hcg_double category_type;
      ...
      template<>
       struct integrity< ::color::category::hcg_ldouble >
        {
         public:
          typedef ::color::category::hcg_ldouble category_type;
