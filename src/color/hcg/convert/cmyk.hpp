#ifndef color_hcg_convert_cmyk
#define color_hcg_convert_cmyk
  ...
  namespace _internal
   {
    ...
    template< typename hcg_tag_name, typename cmyk_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = hcg_model_type( rgb_model_type( cmyk_model_type( right ) ) ).container();
          }
        };
