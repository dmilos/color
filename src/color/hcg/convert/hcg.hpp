#ifndef color_hcg_convert_hcg
#define color_hcg_convert_hcg
  ...
  namespace _internal
   {
    ...
    template< typename tag_left_name, typename tag_right_name >
     struct convert
       <
         ::color::category::hcg< tag_left_name >
        ,::color::category::hcg< tag_right_name>
       >
       {
        public:
           typedef ::color::category::hcg< tag_left_name > category_left_type;
           typedef ::color::category::hcg< tag_right_name> category_right_type;
