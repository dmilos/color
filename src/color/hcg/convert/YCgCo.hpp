#ifndef color_hcg_convert_YCgCo
#define color_hcg_convert_YCgCo
  ...
  namespace _internal
   {
    ...
    template< typename hcg_tag_name, typename YCgCo_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = hcg_model_type( rgb_model_type( YCgCo_model_type( right ) ) ).container();
          }
        };
