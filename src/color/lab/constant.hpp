#ifndef color_contant_lab
#define color_contant_lab

// ::color::constant::lab< typename ::color::akin::lab< category_name >::akin_type >::()
// ::color::constant::lab< category_name >::q_max()
     ...
     struct lab
      {
       public:
         ...
         typedef ::color::constant::lab<category_type> this_type;
