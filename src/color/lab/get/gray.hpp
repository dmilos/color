   ...
   namespace get
    {
     ...
     template< typename tag_name >
      inline
      typename ::color::trait::component< typename ::color::akin::gray< ::color::category::lab<tag_name> >::akin_type >::return_type
      gray( ::color::model< ::color::category::lab<tag_name> > const& color_parameter )
       {
