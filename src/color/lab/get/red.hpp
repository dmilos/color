#ifndef color_lab_get_red
#define color_lab_get_red
   ...
   namespace get
    {
     ...
     template< typename tag_name >
      ...
      red( ::color::model< ::color::category::lab<tag_name> > const& color_parameter )
       { // TODO
        ...
        typedef ::color::constant::lab<category_type> lab_const_type;
        ...
        static scalar_type a11 = lab_const_type::a11(), a12 = lab_const_type::a12(), a13 = lab_const_type::a13();
        ...
        i = ( scalar_type(2) * i - scalar_type(1) ) * lab_const_type::i_max();
        q = ( scalar_type(2) * q - scalar_type(1) ) * lab_const_type::q_max();
