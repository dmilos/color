#ifndef color__internal_lab_bound_positive
#define color__internal_lab_bound_positive

// ::color::_internal::lab::bound::positive< index_name, umber_name, reference_number  >
