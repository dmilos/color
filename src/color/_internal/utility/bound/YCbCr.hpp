#ifndef color__internal_utility_bound_YCbCr
#define color__internal_utility_bound_YCbCr

// ::color::_internal::utility::bound::YCbCr_scalar< index_type, scalar_name >
      ...
      namespace bound
       {
        ...
        template< typename index_name, typename scalar_name/*, TODO YCbCr::reference_emum reference_name*/  >
         struct YCbCr_scalar
          {
           public:
             ...
             template< index_instance_type index >
              static /*constexpr*/ return_image_type   maximum( )
               {
                static instance_type max_list[] = { 1, 0.886, 0.886 };
                return max_list[index];
               }

             static /*constexpr*/ return_image_type   maximum( index_input_const_type  index )
              {
                static instance_type max_list[] = { 1, scalar_type(0.886), scalar_type(0.886) };
                return max_list[index];
              }
             ...
             template< index_instance_type index >
              static /*constexpr*/ return_image_type   minimum( )
               {
                static instance_type min_list[] = { 0, scalar_type(-0.886), scalar_type(-0.886) };
             ...
             template< index_instance_type index >
              static /*constexpr*/ return_image_type   range()
               {
                static instance_type range_list[] = { 1, scalar_type(2*0.886), scalar_type(2*0.886) };
