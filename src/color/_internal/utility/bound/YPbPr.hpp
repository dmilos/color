#ifndef color__internal_utility_bound_YPbPr
#define color__internal_utility_bound_YPbPr

// ::color::_internal::utility::bound::YPbPr_scalar< index_type, scalar_name >
           ...
           public:
             ...
             template< index_instance_type index >
              static /*constexpr*/ return_image_type   maximum( )
               {
                static instance_type max_list[] = { 1, 1, 1 };
