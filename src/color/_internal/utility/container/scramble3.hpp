         ...
         struct scramble3
          {
           public:
             ...
             typedef ::color::_internal::utility::container::scramble3< value_name, first_position, second_position, third_position > this_type;
             ...
             template< index_instance_type index >
              static component_return_const_type get( model_type container )
               {
                //TODO C++14 static_assert( index < 3, "Index is out of range." );
                switch( index )
                 {
                  case( 0 ): return container[first_position];
                  case( 1 ): return container[second_position];
