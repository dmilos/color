#ifndef color__internal_utility_container_cner5551
#define color__internal_utility_container_cner5551

// ::color::_internal::utility::container::cner5551< index_name >
               ...
               switch( index )
                {
                 ...
                 case( 2 ): return ( ( container >>  10 ) & 31 );
                 case( 3 ): return ( ( container >>  15 ) &  1 );
                }
               return 0;
              }
               ...
               switch( index )
                {
                 ...
                 case(2) : container = ( container & ~(  31 << ( 10 ) ) )  |  ( ((instance_type)value) << ( 10 ) ); break;
                 case(3) : container = ( container & ~(   1 << ( 15 ) ) )  |  ( ((instance_type)value) << ( 15 ) ); break;
                }
              }
