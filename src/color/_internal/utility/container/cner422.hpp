#ifndef color__internal_utility_container_cner422
#define color__internal_utility_container_cner422

// ::color::_internal::utility::container::cner422< index_name >
