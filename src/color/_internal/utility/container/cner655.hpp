#ifndef color__internal_utility_container_cner655
#define color__internal_utility_container_cner655

// ::color::_internal::utility::container::cner655< index_name >
              ...
              static set_return_type set( input_type container, index_input_const_type index, component_input_const_type value )
               {
                switch( index )
                 {
                  case(0) : container = ( container & ~(  63 << (  0 ) ) )  |  ( ((instance_type)value) << (  0) ); break;
                  case(1) : container = ( container & ~(  31 << (  6 ) ) )  |  ( ((instance_type)value) << (  6) ); break;
