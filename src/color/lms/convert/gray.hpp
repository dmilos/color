  ...
  namespace _internal
   {
    ...
    template< typename lms_tag_name, typename gray_tag_name >
     struct convert
      <
      ...
      { // TODO
       public:
         typedef ::color::category::lms<   lms_tag_name > category_left_type;
         ...
         typedef ::color::_internal::reformat< category_left_type, lmsSCALAR_category_type, scalar_type >    reformatLAB_type;
