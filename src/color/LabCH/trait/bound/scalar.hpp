         ...
         struct scalar
          {
           public:
             ...
             static instance_type c_max()
              {
               instance_type a = std::max( fabs( lab_bound_type::template minimum<1>() ), lab_bound_type::template maximum<1>() );
               instance_type b = std::max( fabs( lab_bound_type::template minimum<2>() ), lab_bound_type::template maximum<2>() );
               return sqrt( a*a+b*b );
              }
