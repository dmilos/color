#ifndef color_hsi_convert_hcg
#define color_hsi_convert_hcg
  ...
  namespace _internal
   {
    ...
    template< typename hsi_tag_name, typename hcg_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = hsi_model_type( rgb_model_type( hcg_model_type( right ) ) ).container();
          }
      };
