#ifndef color_hsi_make_gainsboro
#define color_hsi_make_gainsboro
   ...
   namespace make
    { //RGB equivalents: std::array<double,3>( { 0.858824, 0.858824, 0.858824 } ) - rgb(219,219,219) - #DBDBDB
     ...
     template< typename tag_name >
      inline
      void gainsboro( ::color::model< ::color::category::hsi< tag_name > > & color_parameter )
       {
        ...
        static left_type local( right_type( { 0, 0, 85.8823529411765 } ) );
