#ifndef color_hwb_get_green
#define color_hwb_get_green
   ...
   namespace get
    {
     ...
     template< typename tag_name >
      inline
      typename ::color::trait::component< typename ::color::akin::rgb< ::color::category::hwb<tag_name> >::akin_type >::return_type
      green( ::color::model< ::color::category::hwb<tag_name> > const& color_parameter )
       {
