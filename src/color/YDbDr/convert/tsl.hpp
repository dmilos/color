#ifndef color_YDbDr_convert_tsl
#define color_YDbDr_convert_tsl
  ...
  namespace _internal
   {
    ...
    template< typename YDbDr_tag_name, typename tsl_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = YDbDr_model_type( rgb_model_type( tsl_model_type( right ) ) ).container();
          }
        };
