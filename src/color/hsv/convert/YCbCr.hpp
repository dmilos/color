#ifndef color_hsv_convert_YCbCr
#define color_hsv_convert_YCbCr
  ...
  namespace _internal
   {
    ...
    template< typename hsv_tag_name, typename YCbCr_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = hsv_model_type( rgb_model_type( YCbCr_model_type( right ) ) ).container();
          }
        };
