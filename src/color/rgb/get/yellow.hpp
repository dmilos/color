   ...
   namespace get
    {
     namespace _internal
      ...
      yellow( ::color::_internal::model< color::category::rgb_uint8 > const& color_parameter )
       {
        return ::color::get::_internal::rgb::_internal::yellow<color::category::rgb_uint8>( color_parameter );
       }
