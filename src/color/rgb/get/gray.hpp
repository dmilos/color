   ...
   namespace get
    {
     namespace _internal
            ...
            gray( ::color::_internal::model< category_name > const& color_parameter  )
             {
              ...
              return trait_type::component_type( value * trait_type::template range<0>() + trait_type::template minimum<0>() );
             }
      ...
      gray( ::color::_internal::model< color::category::rgb_uint8 > const& color_parameter )
       {
        return ::color::get::_internal::rgb::_internal::gray<color::category::rgb_uint8>( color_parameter );
       }
      ...
      gray( ::color::_internal::model< color::category::rgb_uint16 > const& color_parameter )
       {
        return ::color::get::_internal::rgb::_internal::gray<color::category::rgb_uint16>( color_parameter );
       };
      ...
      gray( ::color::_internal::model< color::category::rgb_uint32 > const& color_parameter )
       {
        return ::color::get::_internal::rgb::_internal::gray<color::category::rgb_uint32>( color_parameter );
       };
      ...
      gray( ::color::_internal::model< color::category::rgb_uint64 > const& color_parameter )
       {
        return ::color::get::_internal::rgb::_internal::gray<color::category::rgb_uint64>( color_parameter );
       };
      ...
      gray( ::color::_internal::model< color::category::rgb_float > const& color_parameter )
       {
        return ::color::get::_internal::rgb::_internal::gray<color::category::rgb_float>( color_parameter );
       };
      ...
      gray( ::color::_internal::model< color::category::rgb_double > const& color_parameter )
       {
        return ::color::get::_internal::rgb::_internal::gray<color::category::rgb_double>( color_parameter );
       };
      ...
      gray( ::color::_internal::model< color::category::rgb_ldouble > const& color_parameter )
       {
        return ::color::get::_internal::rgb::_internal::gray<color::category::rgb_ldouble>( color_parameter );
       };
