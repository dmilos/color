   ...
   namespace get
    {
       ...
       namespace green
        {
         ...
         template
          <
           ...
           ,enum ::color::get::constant::green::formula_enum formula_number = ::color::get::constant::green::channel_entity
          >
          struct usher
           {
         ...
         template< typename tag_name >
          struct usher< ::color::category::rgb< tag_name >, color::get::constant::green::hsl_star_entity >
           {
     ...
     template
      ...
      typename ::color::model< ::color::category::rgb< tag_name> >::component_const_type
       ...
       {
        return ::color::get::_internal::green::usher< ::color::category::rgb< tag_name >, formula_number >::process( color_parameter );
       }
