  ...
  namespace operation
   {
     ...
     normalize
      (
       ::color::_internal::model<::color::category::rgb_float>         const& m
     ...
     normalize
      (
       ::color::_internal::model<::color::category::rgb_double>         const& m
     ...
     normalize
      (
       ::color::_internal::model<::color::category::rgb_ldouble>         const& m
