   ...
   namespace set
    {
     namespace _internal
      ...
      yellow
       ...
       {
        ::color::set::_internal::_privateYIQ::yellow<::color::category::yiq_uint8>( color_parameter, component_parameter );
       };
      ...
      yellow
       ...
       {
        ::color::set::_internal::_privateYIQ::yellow<::color::category::yiq_uint16>( color_parameter, component_parameter );
       };
      ...
      yellow
       ...
       {
        ::color::set::_internal::_privateYIQ::yellow<::color::category::yiq_uint32>( color_parameter, component_parameter );
       };
      ...
      yellow
       ...
       {
        ::color::set::_internal::_privateYIQ::yellow<::color::category::yiq_uint64>( color_parameter, component_parameter );
       };
      ...
      yellow
       ...
       {
        ::color::set::_internal::_privateYIQ::yellow<::color::category::yiq_float>( color_parameter, component_parameter );
       };
      ...
      yellow
       ...
       {
        ::color::set::_internal::_privateYIQ::yellow<::color::category::yiq_double>( color_parameter, component_parameter );
       };
      ...
      yellow
       ...
       {
        ::color::set::_internal::_privateYIQ::yellow<::color::category::yiq_ldouble>( color_parameter, component_parameter );
       };
