...
// ::color::make::gainsboro( c )
 ...
 namespace color
  {
   namespace make
    { //RGB equivalents: std::array<double,3>( { 0.86, 0, 0 } ) - rgb(219,219,219) - #dbdbdb
      ...
      void gainsboro( ::color::_internal::model< ::color::category::yiq_uint64 > & color_parameter )
       {
        color_parameter.container() = std::array< std::uint64_t, 3 >( { 0xdc28f5c28f5c2800ull, 0x8000000000000000ull, 0x8000000000000000ull } );
       }
