   ...
   namespace get
    {
     namespace _internal
      ...
      gray( ::color::_internal::model< color::category::yiq_uint8 > const& color_parameter )
       {
        return ::color::get::_internal::_privateYIQ::gray<color::category::yiq_uint8>( color_parameter );
       }
      ...
      gray( ::color::_internal::model< color::category::yiq_uint16 > const& color_parameter )
       {
        return ::color::get::_internal::_privateYIQ::gray<color::category::yiq_uint16>( color_parameter );
       };
      ...
      gray( ::color::_internal::model< color::category::yiq_uint32 > const& color_parameter )
       {
        return ::color::get::_internal::_privateYIQ::gray<color::category::yiq_uint32>( color_parameter );
       };
      ...
      gray( ::color::_internal::model< color::category::yiq_uint64 > const& color_parameter )
       {
        return ::color::get::_internal::_privateYIQ::gray<color::category::yiq_uint64>( color_parameter );
       };
      ...
      gray( ::color::_internal::model< color::category::yiq_float > const& color_parameter )
       {
        return ::color::get::_internal::_privateYIQ::gray<color::category::yiq_float>( color_parameter );
       };
      ...
      gray( ::color::_internal::model< color::category::yiq_double > const& color_parameter )
       {
        return ::color::get::_internal::_privateYIQ::gray<color::category::yiq_double>( color_parameter );
       };
      ...
      gray( ::color::_internal::model< color::category::yiq_ldouble > const& color_parameter )
       {
        return ::color::get::_internal::_privateYIQ::gray<color::category::yiq_ldouble>( color_parameter );
       };
