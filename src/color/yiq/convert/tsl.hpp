#ifndef color_yiq_convert_tsl
#define color_yiq_convert_tsl
  ...
  namespace _internal
   {
    ...
    template< typename yiq_tag_name, typename tsl_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = yiq_model_type( rgb_model_type( tsl_model_type( right ) ) ).container();
          }
        };
