#ifndef color_tsl_convert_YCgCo
#define color_tsl_convert_YCgCo
  ...
  namespace _internal
   {
    ...
    template< typename tsl_tag_name, typename YCgCo_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = tsl_model_type( rgb_model_type( YCgCo_model_type( right ) ) ).container();
          }
      };
