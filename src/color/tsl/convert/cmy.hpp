#ifndef color_tsl_convert_cmy
#define color_tsl_convert_cmy
  ...
  namespace _internal
   {
    ...
    template< typename tsl_tag_name, typename cmy_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = tsl_model_type( rgb_model_type( cmy_model_type( right ) ) ).container();
          }
      };
