#ifndef color_tsl_convert_yiq
#define color_tsl_convert_yiq
  ...
  namespace _internal
   {
    ...
    template< typename tsl_tag_name, typename yiq_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = tsl_model_type( rgb_model_type( yiq_model_type( right ) ) ).container();
          }
      };
