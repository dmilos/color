#ifndef color_tsl_convert_cmyk
#define color_tsl_convert_cmyk
  ...
  namespace _internal
   {
    ...
    template< typename tsl_tag_name, typename cmyk_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = tsl_model_type( rgb_model_type( cmyk_model_type( right ) ) ).container();
          }
      };
