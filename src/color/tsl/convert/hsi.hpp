#ifndef color_tsl_convert_hsi
#define color_tsl_convert_hsi
  ...
  namespace _internal
   {
    ...
    template< typename tsl_tag_name, typename hsi_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = tsl_model_type( rgb_model_type( hsi_model_type( right ) ) ).container();
          }
      };
