#ifndef color_tsl_convert_xyy
#define color_tsl_convert_xyy
  ...
  namespace _internal
   {
    ...
    template< typename tsl_tag_name, typename xyy_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = tsl_model_type( rgb_model_type( xyz_model_type( xyy_model_type( right ) ) ) ).container();
          }
      };
