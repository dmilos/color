#ifndef color_tsl_convert_luv
#define color_tsl_convert_luv
  ...
  namespace _internal
   {
    ...
    template< typename tsl_tag_name, typename luv_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = tsl_model_type( rgb_model_type( xyz_model_type( luv_model_type( right ) ) ) ).container();
          }
      };
