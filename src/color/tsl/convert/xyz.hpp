#ifndef color_tsl_convert_xyz
#define color_tsl_convert_xyz
  ...
  namespace _internal
   {
    ...
    template< typename tsl_tag_name, typename xyz_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = tsl_model_type( rgb_model_type( xyz_model_type( right ) ) ).container();
          }
      };
