  ...
  namespace _internal
   {
    ...
    template< typename luv_tag_name, typename gray_tag_name >
     struct convert
      <
      ...
      { // TODO
       public:
         typedef ::color::category::luv<   luv_tag_name > category_left_type;
         ...
         typedef ::color::_internal::reformat< category_left_type, luvSCALAR_category_type, scalar_type >    reformatLAB_type;
