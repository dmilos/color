#ifndef color_YCbCr_convert_cmyk
#define color_YCbCr_convert_cmyk
  ...
  namespace _internal
   {
    ...
    template< typename YCbCr_tag_name, typename cmyk_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = YCbCr_model_type( rgb_model_type( cmyk_model_type( right ) ) ).container();
          }
        };
