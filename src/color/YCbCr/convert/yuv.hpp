#ifndef color_YCbCr_convert_yuv
#define color_YCbCr_convert_yuv
  ...
  namespace _internal
   {
    ...
    template< typename YCbCr_tag_name, typename yuv_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = YCbCr_model_type( rgb_model_type( yuv_model_type( right ) ) ).container();
          }
        };
