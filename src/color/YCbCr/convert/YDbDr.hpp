#ifndef color_YCbCr_convert_YDbDr
#define color_YCbCr_convert_YDbDr
  ...
  namespace _internal
   {
    ...
    template< typename YCbCr_tag_name, typename YDbDr_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = YCbCr_model_type( rgb_model_type( YDbDr_model_type( right ) ) ).container();
          }
        };
