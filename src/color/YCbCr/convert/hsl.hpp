#ifndef color_YCbCr_convert_hsl
#define color_YCbCr_convert_hsl
  ...
  namespace _internal
   {
    ...
    template< typename YCbCr_tag_name, typename hsl_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = YCbCr_model_type( rgb_model_type( hsl_model_type( right ) ) ).container();
          }
        };
