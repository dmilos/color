#ifndef color_YCbCr_convert_YCgCo
#define color_YCbCr_convert_YCgCo
  ...
  namespace _internal
   {
    ...
    template< typename YCbCr_tag_name, typename YCgCo_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = YCbCr_model_type( rgb_model_type( YCgCo_model_type( right ) ) ).container();
          }
        };
