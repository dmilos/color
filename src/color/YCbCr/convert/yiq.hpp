#ifndef color_YCbCr_convert_yiq
#define color_YCbCr_convert_yiq
  ...
  namespace _internal
   {
    ...
    template< typename YCbCr_tag_name, typename yiq_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = YCbCr_model_type( rgb_model_type( yiq_model_type( right ) ) ).container();
          }
        };
