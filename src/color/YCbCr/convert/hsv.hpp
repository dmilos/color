#ifndef color_YCbCr_convert_hsv
#define color_YCbCr_convert_hsv
  ...
  namespace _internal
   {
    ...
    template< typename YCbCr_tag_name, typename hsv_tag_name >
     struct convert
      <
      ...
      >
      {
       public:
         ...
         static void process
          ...
          {
           left = YCbCr_model_type( rgb_model_type( hsv_model_type( right ) ) ).container();
          }
        };
