...
int main( int argc, char *argv[] )
 {
  ...
  lab<std::uint8_t>    c1( ::color::constant::gray_t<1,2>{} );
  lab<std::uint16_t>   c2( ::color::constant::gray_t<1,2>{} );
  lab<std::uint64_t>   c4( ::color::constant::gray_t<1,2>{} );
  lab<double>          c6( ::color::constant::gray_t<1,2>{} );
