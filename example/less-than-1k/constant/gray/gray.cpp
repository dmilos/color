...
int main( int argc, char *argv[] )
 {
  ...
  gray<std::uint8_t>    c1( ::color::constant::gray_t<1,2>{} );
  gray<std::uint16_t>   c2( ::color::constant::gray_t<1,2>{} );
  gray<std::uint64_t>   c4( ::color::constant::gray_t<1,2>{} );
  gray<double>          c6( ::color::constant::gray_t<1,2>{} );
