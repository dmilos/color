...
int main( int argc, char *argv[] )
 {
  ...
  rgb<std::uint8_t>    c1( ::color::constant::gray_t<1,2>{} );
  rgb<std::uint16_t>   c2( ::color::constant::gray_t<1,2>{} );
  rgb<std::uint64_t>   c4( ::color::constant::gray_t<1,2>{} );
  rgb<double>          c6( ::color::constant::gray_t<1,2>{} );
