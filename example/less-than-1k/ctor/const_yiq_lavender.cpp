...
int main( int argc, char *argv[] )
 {
  ...
  ::color::yiq<::color::type::split422_t>   c1( ::color::constant::lavender_type{} );
  ::color::yiq<::color::type::split655_t >  c2( ::color::constant::lavender_type{} );
  ::color::yiq<std::uint8_t>                c3( ::color::constant::lavender_type{} );
