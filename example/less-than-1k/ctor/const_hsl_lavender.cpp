...
int main( int argc, char *argv[] )
 {
  ...
  ::color::hsl<::color::type::split422_t>   c1( ::color::constant::lavender_type{} );
  ::color::hsl<::color::type::split655_t >  c2( ::color::constant::lavender_type{} );
  ::color::hsl<std::uint8_t>                c3( ::color::constant::lavender_type{} );
