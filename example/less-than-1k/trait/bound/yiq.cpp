...
int main( int argc, char *argv[] )
 {
  print< ::color::yiq<float>::bound_type   >();
  print< ::color::yiq<double>::bound_type  >();
  print< ::color::yiq<uint8_t>::bound_type >();
  print< ::color::yiq<uint16_t>::bound_type >();
  print< ::color::yiq<uint32_t>::bound_type >();
