...
int main( int argc, char *argv[] )
 {
  print< ::color::rgb<float>::bound_type   >();
  print< ::color::rgb<double>::bound_type  >();
  print< ::color::rgb<uint8_t>::bound_type >();
  print< ::color::rgb<uint16_t>::bound_type >();
  print< ::color::rgb<uint32_t>::bound_type >();
