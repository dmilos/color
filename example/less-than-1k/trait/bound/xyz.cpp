...
int main( int argc, char *argv[] )
 {
  print< ::color::xyz<float>::bound_type   >();
  print< ::color::xyz<double>::bound_type  >();
  print< ::color::xyz<uint8_t>::bound_type >();
  print< ::color::xyz<uint16_t>::bound_type >();
  print< ::color::xyz<uint32_t>::bound_type >();
