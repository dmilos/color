...
int main( int argc, char *argv[] )
 {
  print< ::color::xyy<float>::bound_type   >();
  print< ::color::xyy<double>::bound_type  >();
  print< ::color::xyy<uint8_t>::bound_type >();
  print< ::color::xyy<uint16_t>::bound_type >();
  print< ::color::xyy<uint32_t>::bound_type >();
