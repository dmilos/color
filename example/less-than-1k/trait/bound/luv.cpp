...
int main( int argc, char *argv[] )
 {
  print< ::color::luv<float>::bound_type   >();
  print< ::color::luv<double>::bound_type  >();
  print< ::color::luv<uint8_t>::bound_type >();
  print< ::color::luv<uint16_t>::bound_type >();
  print< ::color::luv<uint32_t>::bound_type >();
