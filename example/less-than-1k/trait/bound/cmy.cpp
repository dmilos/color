...
int main( int argc, char *argv[] )
 {
  print< ::color::cmy<float>::bound_type >();
  print< ::color::cmy<double>::bound_type >();
  print< ::color::cmy<uint8_t>::bound_type >();
  print< ::color::cmy<uint16_t>::bound_type >();
  print< ::color::cmy<uint32_t>::bound_type >();
