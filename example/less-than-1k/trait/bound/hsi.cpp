...
int main( int argc, char *argv[] )
 {
  print< ::color::hsi<float>::bound_type   >();
  print< ::color::hsi<double>::bound_type  >();
  print< ::color::hsi<uint8_t>::bound_type >();
  print< ::color::hsi<uint16_t>::bound_type >();
  print< ::color::hsi<uint32_t>::bound_type >();
