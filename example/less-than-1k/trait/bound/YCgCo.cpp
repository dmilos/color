...
int main( int argc, char *argv[] )
 {
  print< ::color::YCgCo<float>::bound_type   >();
  print< ::color::YCgCo<double>::bound_type  >();
  print< ::color::YCgCo<uint8_t>::bound_type >();
  print< ::color::YCgCo<uint16_t>::bound_type >();
  print< ::color::YCgCo<uint32_t>::bound_type >();
