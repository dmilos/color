...
int main( int argc, char *argv[] )
 {
  print< ::color::YDbDr<float>::bound_type   >();
  print< ::color::YDbDr<double>::bound_type  >();
  print< ::color::YDbDr<uint8_t>::bound_type >();
  print< ::color::YDbDr<uint16_t>::bound_type >();
  print< ::color::YDbDr<uint32_t>::bound_type >();
