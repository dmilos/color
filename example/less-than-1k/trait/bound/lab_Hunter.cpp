...
int main( int argc, char *argv[] )
 {
  print< lab<float>::bound_type   , Hunter_entity >();
  print< lab<double>::bound_type  , Hunter_entity >();
  print< lab<uint8_t>::bound_type , Hunter_entity >();
  print< lab<uint16_t>::bound_type, Hunter_entity >();
  print< lab<uint32_t>::bound_type, Hunter_entity >();
