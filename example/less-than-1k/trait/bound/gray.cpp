...
int main( int argc, char *argv[] )
 {
  print< ::color::gray<float>::bound_type   >();
  print< ::color::gray<double>::bound_type  >();
  print< ::color::gray<uint8_t>::bound_type >();
  print< ::color::gray<uint16_t>::bound_type >();
  print< ::color::gray<uint32_t>::bound_type >();
