...
int main( int argc, char *argv[] )
 {
  print< ::color::hsv<float>::bound_type   >();
  print< ::color::hsv<double>::bound_type  >();
  print< ::color::hsv<uint8_t>::bound_type >();
  print< ::color::hsv<uint16_t>::bound_type >();
  print< ::color::hsv<uint32_t>::bound_type >();
