...
int main( int argc, char *argv[] )
 {
  print< ::color::yuv<float>::bound_type >();
  print< ::color::yuv<double>::bound_type >();
  print< ::color::yuv<uint8_t>::bound_type >();
  print< ::color::yuv<uint16_t>::bound_type >();
  print< ::color::yuv<uint32_t>::bound_type >();
