...
int main( int argc, char *argv[] )
 {
  print< ::color::lms<float>::bound_type   >();
  print< ::color::lms<double>::bound_type  >();
  print< ::color::lms<uint8_t>::bound_type >();
  print< ::color::lms<uint16_t>::bound_type >();
  print< ::color::lms<uint32_t>::bound_type >();
