...
int main( int argc, char *argv[] )
 {
  print< ::color::lab<float>::bound_type   >();
  print< ::color::lab<double>::bound_type  >();
  print< ::color::lab<uint8_t>::bound_type >();
  print< ::color::lab<uint16_t>::bound_type >();
  print< ::color::lab<uint32_t>::bound_type >();
