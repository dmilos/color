...
int main( int argc, char *argv[] )
 {
  print< ::color::cmyk<float>::bound_type   >();
  print< ::color::cmyk<double>::bound_type  >();
  print< ::color::cmyk<uint8_t>::bound_type >();
  print< ::color::cmyk<uint16_t>::bound_type >();
  print< ::color::cmyk<uint32_t>::bound_type >();
