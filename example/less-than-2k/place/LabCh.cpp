...
int main( int argc, char *argv[] )
 {
  typedef ::color::LabCH<double>::category_type  category_type;

  std::cout<< "Memory ( and index ) positions of component in LabCH<double>" << std::endl;

  std::cout<< "    black      " << ::color::place::black       <category_type>() << std::endl
           ...
           << "    key        " << ::color::place::key         <category_type>() << std::endl
