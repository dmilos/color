 ...
 void test_set( double value )
  {
   ...
   color::set::cyan(     c, value ); std::cout << "  color::set::cyan(     c, "<<value<<" ); "; print(c); std::cout << "  ( double )color::get::cyan( c )    == "<< ( double )color::get::cyan( c )     ;std::cout << std::endl;
   ...
   color::set::magenta(  c, value ); std::cout << "  color::set::magenta(  c, "<<value<<" ); "; print(c); std::cout << "  ( double )color::get::magenta( c ) == "<< ( double )color::get::magenta( c )  ;std::cout << std::endl;
   ...
   color::set::yellow(   c, value ); std::cout << "  color::set::yellow(   c, "<<value<<" ); "; print(c); std::cout << "  ( double )color::get::yellow( c )  == "<< ( double )color::get::yellow( c )   ;std::cout << std::endl;
