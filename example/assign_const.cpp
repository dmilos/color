...
//color::cmy<bool>           c0; //!< Not yet supported
  color::cmy<std::uint8_t>   c1; c1 = ::color::constant::lavender{};
  color::cmy<std::uint16_t>  c2; c2 = ::color::constant::lavender{};
  color::cmy<std::uint32_t>  c3; c3 = ::color::constant::lavender{};
  color::cmy<std::uint64_t>  c4; c4 = ::color::constant::lavender{};
  color::cmy<float>          c5; c5 = ::color::constant::lavender{};
  color::cmy<double>         c6; c6 = ::color::constant::lavender{};
  color::cmy<long double>    c7; c7 = ::color::constant::lavender{};
...
//color::cmyk<bool>           c0( { true, false, false } ); //!< Not yet supported
  color::cmyk<std::uint8_t>   c1; c1 = ::color::constant::lavender{};
  color::cmyk<std::uint16_t>  c2; c2 = ::color::constant::lavender{};
  color::cmyk<std::uint32_t>  c3; c3 = ::color::constant::lavender{};
  color::cmyk<std::uint64_t>  c4; c4 = ::color::constant::lavender{};
  color::cmyk<float>          c5; c5 = ::color::constant::lavender{};
  color::cmyk<double>         c6; c6 = ::color::constant::lavender{};
  color::cmyk<long double>    c7; c7 = ::color::constant::lavender{};
...
void assign_const_hsl()
 {
  ...
  color::hsl<std::uint8_t>   c1; c1 = ::color::constant::lavender{};
  color::hsl<std::uint16_t>  c2; c2 = ::color::constant::lavender{};
  color::hsl<std::uint32_t>  c3; c3 = ::color::constant::lavender{};
  color::hsl<std::uint64_t>  c4; c4 = ::color::constant::lavender{};
  color::hsl<float>          c5; c5 = ::color::constant::lavender{};
  color::hsl<double>         c6; c6 = ::color::constant::lavender{};
  color::hsl<long double>    c7; c7 = ::color::constant::lavender{};
...
//color::hsv<bool>           c0( { true, false, false} ); //!< Not yet supported
  color::hsv<std::uint8_t>   c1; c1 = ::color::constant::lavender{};
  color::hsv<std::uint16_t>  c2; c2 = ::color::constant::lavender{};
  color::hsv<std::uint32_t>  c3; c3 = ::color::constant::lavender{};
  color::hsv<std::uint64_t>  c4; c4 = ::color::constant::lavender{};
  color::hsv<float>          c5; c5 = ::color::constant::lavender{};
  color::hsv<double>         c6; c6 = ::color::constant::lavender{};
  color::hsv<long double>    c7; c7 = ::color::constant::lavender{};
...
void assign_const_rgb()
 {
  ...
  color::rgb<std::uint8_t>   c1; c1 = ::color::constant::lavender{};
  color::rgb<std::uint16_t>  c2; c2 = ::color::constant::lavender{};
  color::rgb<std::uint32_t>  c3; c3 = ::color::constant::lavender{};
  color::rgb<std::uint64_t>  c4; c4 = ::color::constant::lavender{};
  color::rgb<float>          c5; c5 = ::color::constant::lavender{};
  color::rgb<double>         c6; c6 = ::color::constant::lavender{};
  color::rgb<long double>    c7; c7 = ::color::constant::lavender{};
...
//color::yiq<bool>           c0( { true, false, false} ); //!< Not yet supported
  color::yiq<std::uint8_t>   c1; c1 = ::color::constant::lavender{};
  color::yiq<std::uint16_t>  c2; c2 = ::color::constant::lavender{};
  color::yiq<std::uint32_t>  c3; c3 = ::color::constant::lavender{};
  color::yiq<std::uint64_t>  c4; c4 = ::color::constant::lavender{};
  color::yiq<float>          c5; c5 = ::color::constant::lavender{};
  color::yiq<double>         c6; c6 = ::color::constant::lavender{};
  color::yiq<long double>    c7; c7 = ::color::constant::lavender{};
...
void assign_const_yuv()
 {
  ...
  color::yuv<std::uint8_t>   c1; c1 = ::color::constant::lavender{};
  color::yuv<std::uint16_t>  c2; c2 = ::color::constant::lavender{};
  color::yuv<std::uint32_t>  c3; c3 = ::color::constant::lavender{};
  color::yuv<std::uint64_t>  c4; c4 = ::color::constant::lavender{};
  color::yuv<float>          c5; c5 = ::color::constant::lavender{};
  color::yuv<double>         c6; c6 = ::color::constant::lavender{};
  color::yuv<long double>    c7; c7 = ::color::constant::lavender{};
