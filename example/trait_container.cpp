...
void trait_container_in_cmyk()
 {
  std::cout << "container for color::cmy< std::uint8_t  > is: " << typeid( ::color::trait::container< color::cmyk< std::uint8_t  >::category_type >::instance_type ).name() << std::endl;
  std::cout << "container for color::cmy< std::uint16_t > is: " << typeid( ::color::trait::container< color::cmyk< std::uint16_t >::category_type >::instance_type ).name() << std::endl;
  std::cout << "container for color::cmy< std::uint32_t > is: " << typeid( ::color::trait::container< color::cmyk< std::uint32_t >::category_type >::instance_type ).name() << std::endl;
  std::cout << "container for color::cmy< std::uint64_t > is: " << typeid( ::color::trait::container< color::cmyk< std::uint64_t >::category_type >::instance_type ).name() << std::endl;
  std::cout << "container for color::cmy< float         > is: " << typeid( ::color::trait::container< color::cmyk< float         >::category_type >::instance_type ).name() << std::endl;
  std::cout << "container for color::cmy< double        > is: " << typeid( ::color::trait::container< color::cmyk< double        >::category_type >::instance_type ).name() << std::endl;
  std::cout << "container for color::cmy< long double   > is: " << typeid( ::color::trait::container< color::cmyk< long double   >::category_type >::instance_type ).name() << std::endl;
 }
