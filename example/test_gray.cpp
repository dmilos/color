...
void print( color::gray_uint32 const& u32 )
 {
  std::cout << "[";
...
void test_gray_uint32_only()
 {
  color::gray_uint32   u32;
  color::gray_uint32   u32a;
  color::gray_uint32   u32b;
  color::gray_uint32   u32c;
  print( u32 );
  u32.get(0);
  u32.get<0>();
  unsigned uu = u32[0];
