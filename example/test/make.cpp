...
void make_check_red_in()
 {
  std::cout << "--------------" << std::endl;
  color::rgb<double>    r;    color::make::magenta( r ); std::cout << "color::rgb<double>   "; print( r  ) ;  std::cout << std::endl;
  
  color::rgb<float>     f    ( r ); std::cout << "color::rgb<float>   "; print( f  ) ;  std::cout << std::endl;
