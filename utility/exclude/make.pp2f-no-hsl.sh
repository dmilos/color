...
pp2f0=color.pp2f0-no-hsl.hpp
pp2f1=color.pp2f1-no-hsl.hpp
pp2f2=color.pp2f2-no-hsl.hpp
pp2f3=color.pp2f3-no-hsl.hpp
pp2f4=color.pp2f4-no-hsl.hpp
...
g++ ../../src/color/color.body.hpp  -o ./${output_dir}/${pp2f0} -E  -D COLOR_EXCLUDE_MODEL_HSL
