...
g++ ../../src/color/color.body.hpp  -o ./out/color.pp2f0.hpp -E  -D COLOR_EXCLUDE_MODEL_HSL
...
rm  ./out/color.pp2f4-no-hsl.hpp
cat                             < ../../src/color/copyright.hpp     > ./out/color.pp2f4-no-hsl.hpp
cat                             < ./out/color.pp2f3.hpp            >> ./out/color.pp2f4-no-hsl.hpp