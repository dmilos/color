...
pp2f0=color.pp2f0-no-hue.hpp
pp2f1=color.pp2f1-no-hue.hpp
pp2f2=color.pp2f2-no-hue.hpp
pp2f3=color.pp2f3-no-hue.hpp
pp2f4=color.pp2f4-no-hue.hpp

GCC_MACRO_SWITCH=

GCC_MACRO_SWITCH=${GCC_MACRO_SWITCH}" -D COLOR_EXCLUDE_MODEL_HSI"
GCC_MACRO_SWITCH=${GCC_MACRO_SWITCH}" -D COLOR_EXCLUDE_MODEL_HSL"
GCC_MACRO_SWITCH=${GCC_MACRO_SWITCH}" -D COLOR_EXCLUDE_MODEL_HSV"
